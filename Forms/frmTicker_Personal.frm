VERSION 5.00
Begin VB.Form frmTicker_Personal 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Personal Ticker Message"
   ClientHeight    =   3105
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   5160
   ...
   EndProperty
   Icon            =   "frmTicker_Personal.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3105
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox yyyy 
         Height          =   315
         ItemData        =   "frmTicker_Personal.frx":000C
         Left            =   2760
         List            =   "frmTicker_Personal.frx":000E
      ...
      Begin VB.ComboBox dd 
         Height          =   315
         ItemData        =   "frmTicker_Personal.frx":0010
         Left            =   1320
         List            =   "frmTicker_Personal.frx":0074
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   360
         Width           =   615
      ...
      Begin VB.ComboBox mm 
         Height          =   315
         ItemData        =   "frmTicker_Personal.frx":00F6
         Left            =   2040
         List            =   "frmTicker_Personal.frx":0121
         Style           =   2  'Dropdown List
         TabIndex        =   5
         ToolTipText     =   "Month"
         Top             =   360
   ...
   End
End
Attribute VB_Name = "frmTicker_Personal"
...
Else
    ...
    Else
        ...
        Set tckRS = MySynonDatabase.OpenRecordset(tckSQL, dbOpenDynaset, dbAppendOnly)
            ...
            End If
            tckRS("username") = CurrentUser.strUsername
            tckRS.Update
        tckRS.Close
        Set tckRS = Nothing
